"""
=====================================================================
Comparing different clustering algorithms on cluster density datasets
=====================================================================

This script shows characteristics of different clustering algorithms
on cluster density datasets.
...
file_name = "Outputs/set_6/ClusDen_set_6_sep_10cm_det_120_1week_poca_100um_bins_120.out"
...
plt.savefig('Images/set_6/ClusterAlgos/ScatterPlot_CompareClusterAlgos.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
plt.savefig('Images/set_6/ClusterAlgos/CompareClusterAlgos.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()