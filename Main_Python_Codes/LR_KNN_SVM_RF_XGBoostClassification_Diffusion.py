...
plt.title('Dev_angle vs clus_den Diffusion')
plt.savefig('Dev_angle_vs_Clus_Den_Diffusion', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
if(opt_LR):
    plt.savefig('Images_FeatureImportance_LR_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_SVM):
    plt.savefig('Images_FeatureImportance_SVM_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_KNN):
    plt.savefig('Images_FeatureImportance_KNN_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_RF):
    plt.savefig('Images_FeatureImportance_RF_set_1_sep_10cm_det_120_2days_poca_100um_dissusion.png', dpi=300, bbox_inches='tight')
if(opt_XGB):
    plt.savefig('Images_FeatureImportance_XGB_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
"""
### Confusion matrix
