...
file_name = "Cluster_DIFF_PRM.txt"
...
plt.title('Dev_angle vs clus_den Diffusion_PRM')
plt.savefig('Dev_angle_vs_Clus_Den_Diffusion_PRM', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
accuracy=print_score(model, X_train, y_train, X_test, y_test, train=True)
...
plt.title('Comaprative features importance Diff_PRM')
if(opt_LR):
    plt.savefig('Images_FeatureImportance_LR_set_1_sep_10cm_det_120_2days_poca_100um_diffusion_PRM.png', dpi=300, bbox_inches='tight')
if(opt_SVM):
    plt.savefig('Images_FeatureImportance_SVM_set_1_sep_10cm_det_120_2days_poca_100um_diffusion_PRM.png', dpi=300, bbox_inches='tight')
if(opt_KNN):
    plt.savefig('Images_FeatureImportance_KNN_set_1_sep_10cm_det_120_2days_poca_100um_diffusion_PRM.png', dpi=300, bbox_inches='tight')
if(opt_RF):
    plt.savefig('Images_FeatureImportance_RF_set_1_sep_10cm_det_120_2days_poca_100um_dissusion_PRM.png', dpi=300, bbox_inches='tight')
if(opt_XGB):
    plt.savefig('Images_FeatureImportance_XGB_set_1_sep_10cm_det_120_2days_poca_100um_diffusion_PRM.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
"""
### Confusion matrix
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.text(0.02,0.95, f"Accuracy: {accuracy*100: 0.2f}%",transform=plt.gca().transAxes)
if(opt_LR):
    plt.title("Diffusion_PRM_Hyperplane_LR")
    plt.savefig('Images_HyperSurfaces_LR_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_SVM):
    plt.title("Diffusion_PRM_Hyperplane_SVM")
    plt.savefig('Images_HyperSurfaces_SVM_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_KNN):
    plt.title("Diffusion_PRM_Hyperplane_KNN")
    plt.savefig('Images_HyperSurfaces_KNN_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_RF):
    plt.title("Diffusion_PRM_Hyperplane_RF")
    plt.savefig('Images_HyperSurfaces_RF_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
if(opt_XGB):
    plt.title("Diffusion_PRM_Hyperplane_XGB")
    plt.savefig('Images_HyperSurfaces_XGB_set_1_sep_10cm_det_120_2days_poca_100um_diffusion.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
