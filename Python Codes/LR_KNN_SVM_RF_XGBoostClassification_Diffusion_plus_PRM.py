...
if(opt_LR):
    plt.savefig('LR_set_1_sep_10cm_det_120_2days_poca_100um.png', dpi=300, bbox_inches='tight')
if(opt_SVM):
    plt.savefig('SVM_set_1_sep_10cm_det_120_2days_poca_100um.png', dpi=300, bbox_inches='tight')
if(opt_KNN):
    plt.savefig('KNN_set_1_sep_10cm_det_120_2days_poca_100um.png', dpi=300, bbox_inches='tight')
if(opt_RF):
    plt.savefig('RF_set_1_sep_10cm_det_120_2days_poca_100um.png', dpi=300, bbox_inches='tight')
if(opt_XGB):
    plt.savefig('XGB_set_1_sep_10cm_det_120_2days_poca_100um.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
...
if(opt_LR):
    plt.savefig('LR_set_1_sep_10cm_det_120_2days_poca_DIFFUSION_100um.png', dpi=300, bbox_inches='tight')
if(opt_SVM):
    plt.savefig('SVM_set_1_sep_10cm_det_120_2days_poca_DIFFUSION_100um.png', dpi=300, bbox_inches='tight')
if(opt_KNN):
    plt.savefig('KNN_set_1_sep_10cm_det_120_2days_poca_DIFFUSION_100um.png', dpi=300, bbox_inches='tight')
if(opt_RF):
    plt.savefig('RF_set_1_sep_10cm_det_120_2days_poca_DIFFUSION_100um.png', dpi=300, bbox_inches='tight')
if(opt_XGB):
    plt.savefig('XGB_set_1_sep_10cm_det_120_2days_poca_DIFFUSION_100um.png', dpi=300, bbox_inches='tight')
plt.show()
plt.close()
