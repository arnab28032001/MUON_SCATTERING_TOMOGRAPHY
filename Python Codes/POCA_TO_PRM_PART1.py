...
for s in range(sample_size, len(data_file_all), sample_size):
    ...
    plt.imshow(cluster_density[0].T, origin='lower', cmap='jet',extent=[-300, 300, -300, 300])
    plt.grid()
    plt.colorbar()
    plt.xlabel('X bin (100 micrometer)', fontsize=17) # change value in brackets as needed
    plt.ylabel('Y bin (100 micrometer)', fontsize=17)
    ...
    plt.imshow(average_deviation.T, origin='lower', cmap='jet',extent=[-300, 300, -300, 300])# cmin=2500, cmax=3000)
    plt.grid()
    plt.colorbar()
    plt.xlabel('X bin (100 micrometer)', fontsize=17) # change value in brackets as needed
    plt.ylabel('Y bin (100 micrometer)', fontsize=17)
